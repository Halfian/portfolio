export default function About() {
    return (
        <section
            id="about"
            className="scroll-mt-28 bg-white py-20 px-6 md:px-12 flex flex-col items-center justify-center text-center md:text-left md:flex-row md:gap-12"
        >
            <div className="w-48 h-48 rounded-full overflow-hidden shadow-lg mb-8 md:mb-0">
